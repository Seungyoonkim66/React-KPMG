        ...
        return(
            <div className='solution'>
               <Container>
                    ...
                    <Row id='description'>
                        <Col>
                            <p id='description-title'><strong>Journal Entry OCR</strong><Link to='/ocr'><img src={back} alt='img' id='back-icon'/></Link></p>
                        </Col>
                    </Row>
                    <Row>
                            <Col>
